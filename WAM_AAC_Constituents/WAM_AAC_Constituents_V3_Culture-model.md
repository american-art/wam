...
if constituentType == "Culture":
    return "id/"+getValue("ConstituentID")
else:
    return ""
```
...
#### _CultureURI_
From column: _Root / ObjRecord / Constituents / ObjectRelatedConstituent / CultureValue_
``` python
return getValue("ConstituentURI") + "/culture/"
```
...
| _CultureURI_ | `uri` | `crm:E55_Type3`|
| _CultureValue_ | `rdfs:label` | `crm:E55_Type3`|
